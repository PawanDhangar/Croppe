...
<footer className="bg-white shadow dark:bg-gray-900  min-w-full">
    <div className="w-full container m-0 p-4 md:px-6 md:py-8">
        ...
        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© <a href="https://flowbite.com/" class="hover:underline">Croppe™</a>. All Rights Reserved.</span>
    </div>
</footer>
</div>
  )
